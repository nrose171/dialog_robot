...
def dialog_action_server():
	...
	while not rospy.is_shutdown():
		if flag == True:
			...
			#launch = roslaunch.parent.ROSLaunchParent(uuid, ["/home/santosh/onr_ws/src/Distributed_Collaborative_Task_Tree/table_setting_demo/launch/test.launch"])
